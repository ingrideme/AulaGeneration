programa
{
	...
	{
		real taxapoluente
		escreva("Digite o indice de poluição da empresa: ")
		leia(taxapoluente)
		
		se(taxapoluente <= 0.25) {
		escreva("Indice aceitável")
		
		} senao se (taxapoluente >= 0.26 e taxapoluente <=0.39) {
		escreva("Grupo 1 - Suspensão de atividade")
		} senao se (taxapoluente >= 0.40 e taxapoluente <=0.49) {
		escreva("Grupos 1 e 2 - Suspensão de atividade")
		} senao se (taxapoluente >= 0.5){
		escreva("Todos os grupos - Atividades suspensas")	
		}
		}
}
